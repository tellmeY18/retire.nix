    ...
    omniwm = {
      ...
      settings = {
        ...
        niri = {
          ...
          infiniteLoop = false;
          columnWidthPresets = [ 0.3333333333333333 0.5 0.66 ];
        ...
        hotkeys = [
          # Focus (vim)
          { id = "focus.left"; binding = "Option+H"; }
          { id = "focus.down"; binding = "Option+J"; }
          { id = "focus.up"; binding = "Option+K"; }
          { id = "focus.right"; binding = "Option+L"; }

          # Move windows (vim)
          { id = "move.left"; binding = "Option+Shift+H"; }
          { id = "move.down"; binding = "Option+Shift+J"; }
          { id = "move.up"; binding = "Option+Shift+K"; }
          { id = "move.right"; binding = "Option+Shift+L"; }
          ...
          # Back-and-forth
          { id = "workspaceBackAndForth"; binding = "Option+Tab"; }

          # Fullscreen
          { id = "toggleFullscreen"; binding = "Option+Shift+F"; }

          # Toggle floating
          { id = "toggleFocusedWindowFloating"; binding = "Option+Shift+Space"; }
          ...
          # Quake terminal
          { id = "toggleQuakeTerminal"; binding = "Option+Return"; }

          # Focus next monitor
          { id = "focusMonitorNext"; binding = "Option+Shift+Tab"; }
        ...
        workspaces = [
          ...
          { name = "3"; layoutType = "niri"; monitorAssignment = { type = "main"; }; }
          { name = "4"; layoutType = "niri"; monitorAssignment = { type = "main"; }; }
          { name = "5"; layoutType = "niri"; monitorAssignment = { type = "main"; }; }
          { name = "6"; layoutType = "niri"; monitorAssignment = { type = "secondary"; }; }
          { name = "7"; layoutType = "niri"; monitorAssignment = { type = "secondary"; }; }
          { name = "8"; layoutType = "niri"; monitorAssignment = { type = "secondary"; }; }
          { name = "9"; layoutType = "niri"; monitorAssignment = { type = "secondary"; }; }
        ];

        appRules = [
          { bundleId = "com.apple.finder"; layout = "float"; }
          { bundleId = "com.apple.systempreferences"; layout = "float"; }
          { bundleId = "com.spotify.client"; minWidth = 800.0; minHeight = 600.0; }
          { bundleId = "com.hnc.Discord"; minWidth = 800.0; minHeight = 500.0; }
